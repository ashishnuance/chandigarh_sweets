      ...
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Current Enquiry <i
                     class="material-icons float-right">more_vert</i>
               </h6>
               <p class="medium-small">This enquiry cycle</p>
               <div class="current-balance-container">
                  <div id="current-balance-donut-chart" class="current-balance-shadow"></div>
               </div>
               <h5 class="center-align">150.00</h5>
   ...
   <div class="row">
      <div class="col s12 l6">
         ...
         <div class="card user-statistics-card animate fadeLeft">
            <div class="card-content">
               <h4 class="card-title mb-0">User Register <i class="material-icons float-right">more_vert</i></h4>
               <div class="row">
